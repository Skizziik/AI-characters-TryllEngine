...
static createSendMessageRequest(builder:flatbuffers.Builder, requestId:bigint, agentId:bigint, textOffset:flatbuffers.Offset):flatbuffers.Offset {
  SendMessageRequest.startSendMessageRequest(builder);
  SendMessageRequest.addRequestId(builder, requestId);
  SendMessageRequest.addAgentId(builder, agentId);
